<img src="/img/blog/3_matrices/matrices.png" alt="">
    <h1>Matrices 4x4</h1>
    <hr>
    ...
    <img class="ilustracionMatematica" src="/img/blog/3_matrices/matrices_rotacion.png" alt="Fórmulas matemáticas de las matrices de rotación entorno a los ejes x, y, z.">
    ...
    <img class="ilustracionMatematica" src="/img/blog/3_matrices/operacion_rotacion.png" alt="Fórmula matemática donde se ve que el vector obtenido después de la rotación, es el inicial después de transformarlo con la matriz correspondiente (multiplicar matriz por vector)">
    ...
    <img src="/img/blog/3_matrices/traslacion.png" alt="Imagen donde se ven las fórmulas matemáticas de una matriz de traslación. También se ve cómo aplicar la matriz a un vector para obtener el vector trasladado (multiplicar)">
    <h4>Escala</h4>
    ...
    <img src="/img/blog/3_matrices/escala.png" alt="Imagen donde se ven las fórmulas matemáticas para crear una matriz de escala. También se ve cómo aplicar la matriz a un vector para obtener el vector escalado (multiplicar)">