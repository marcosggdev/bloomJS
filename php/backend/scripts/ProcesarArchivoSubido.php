...
move_uploaded_file($archivoDae['tmp_name'], "/var/www/html/" . $rutaDae);
...
move_uploaded_file($textura['tmp_name'], "/var/www/html/" . $rutaTextura);
...
move_uploaded_file($previsualizacion['tmp_name'], "/var/www/html/" . $rutaPrevisualizacion);
