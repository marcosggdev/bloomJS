    ...
    <script>
        ...
        Array.from(document.querySelectorAll(".plantilla")).forEach((div) => {
            div.addEventListener("click", () => {
                VentanaCanvas.anadirModelo(0,0,0,0,0,0,1,1,1, "T", "/bloomJS/" + div.querySelector("#rutaModelo").value, new Color(0.5,0.5,0.5,1.0), "/bloomJS/" + div.querySelector("#rutaTextura").value, "/bloomsJS/assets/materiales/esfera.mtl");
                //elimina el menu asociado a la plantilla. Para que funcione bien, debemos tener un menu de la forma: menu -> malla -> plantilla
                //hijos directos en ese orden. En caso contrario se eliminara el nodo equivocado
