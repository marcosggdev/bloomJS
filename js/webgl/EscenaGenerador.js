...
class EscenaGenerador {
    ...
    static async crearEscenaGenerador (dibujables) {
        return new Promise(resolve => {
            let escena = new EscenaGenerador(dibujables);

            if (dibujables == null) {
                GridGenerador.crearGridGenerador()
                .then(
                    function (grid) {
                        escena.dibujables.push(grid);
                        resolve(escena);
                    }
                );
            } else {
