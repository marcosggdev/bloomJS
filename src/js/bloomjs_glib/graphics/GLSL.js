//-------------------------------------------C: COLOR------------------------------------------------------------//
export var VERTEX_SHADER_COLOR = 
"uniform mat4 m;\n" +
"uniform mat4 v;\n" +
"uniform mat4 p;\n" +
...
export var FRAGMENT_SHADER_COLOR =
...
export var VERTEX_SHADER_GOURAUD2= 
"uniform mat4 m;\n" +
"uniform mat4 v;\n" +
"uniform mat4 p;\n" +
...
"export varying vec3 vNorm;\n" +
"export varying vec2 vTex;\n" +
"export varying vec3 iAmbiente;\n" +
"export varying vec3 iDifusion;\n" +
"export varying vec3 iEspecular;\n" +
"export varying vec3 vColor;\n" +
"export varying vec3 l;\n" +
...
export var FRAGMENT_SHADER_GOURAUD2 =
"precision highp float;\n" +
...
//-----------------------------------------GOURAUD_T: TEX---------------------------------------------//
export var VERTEX_SHADER_GOURAUD_T= 
"uniform mat4 m;\n" +
"uniform mat4 v;\n" +
"uniform mat4 p;\n" +
...
export var FRAGMENT_SHADER_GOURAUD_T =
"precision highp float;\n" +
...
//PHONG 2 (materiales)
//PHONG SHADING
export var VERTEX_SHADER_PHONG2 = 
"uniform mat4 mv;\n" +
"uniform mat4 m;\n" +
"uniform mat4 p;\n" +
"uniform vec3 uJPos;\n" +
...
export var FRAGMENT_SHADER_PHONG2 =
"precision mediump float;\n" +
"export varying vec3 vNorm;\n" +
"export varying vec3 vPos;\n" +
"uniform sampler2D sampler;\n" +
...
//GOURAUD SHADING
export var VERTEX_SHADER_GOURAUD= 
"uniform mat4 mv;\n" +
"uniform mat4 m;\n" +
"uniform mat4 p;\n" +
"uniform vec3 uJPos;\n" +
...
"export varying vec3 vNorm;\n" +
"export varying vec2 vTex;\n" +
"export varying vec4 iAmbiente;\n" +
"export varying vec4 iDifusion;\n" +
"export varying vec4 iEspecular;\n" +
"export varying vec4 vColor;\n" +
"export varying vec3 l;\n" +
"void main(){\n" +
"   vNorm = normalize((m * vec4(aNorm, 1.0)).xyz);\n" +
...
export var FRAGMENT_SHADER_GOURAUD =
"precision mediump float;\n" +
"export varying vec4 vColor;\n" +
"export varying vec2 vTex;\n" +
"uniform sampler2D sampler;\n" +
...
//PHONG SHADING
export var VERTEX_SHADER_PHONG = 
"uniform mat4 mv;\n" +
"uniform mat4 m;\n" +
"uniform mat4 p;\n" +
"uniform vec3 uJPos;\n" +
...
export var FRAGMENT_SHADER_PHONG =
"precision mediump float;\n" +
"export varying vec3 vNorm;\n" +
"export varying vec3 vPos;\n" +
"uniform sampler2D sampler;\n" +
...
//shaders jugador
//GOURAUD SHADING
export var VERTEX_SHADER_JUGADOR_GOURAUD= 
"uniform mat4 mv;\n" +
"uniform mat4 m;\n" +
"uniform mat4 p;\n" +
"uniform sampler2D sampler;\n" +
...
export var FRAGMENT_SHADER_JUGADOR_GOURAUD =
"precision mediump float;\n" +
"export varying vec4 vColor;\n" +
"export varying vec2 vTex;\n" +
"uniform sampler2D sampler;\n" +
...
//PHONG SHADING
export var VERTEX_SHADER_JUGADOR_PHONG = 
"uniform mat4 mv;\n" +
"uniform mat4 m;\n" +
"uniform mat4 p;\n" +
"uniform sampler2D sampler;\n" +
...
export var FRAGMENT_SHADER_JUGADOR_PHONG =
"precision mediump float;\n" +
"export varying vec3 vNorm;\n" +
"export varying vec3 vPos;\n" +
"uniform sampler2D sampler;\n" +
...
export var VERTEX_SHADER_IMAGE = 
"uniform mat4 m;\n" +
"uniform mat4 v;\n" +
"uniform mat4 p;\n" +
"uniform sampler2D sampler;\n" +
...
export var FRAGMENT_SHADER_IMAGE =
"precision mediump float;\n" +
...
"void main(){\n" +
"   vec4 texture = texture2D(sampler, vTex);\n" + 
"   gl_FragColor = vec4(texture.xyz, 1.0);\n" +
"}\n";

//------------------------------------------GRID--------------------------------------ç
export var VERTEX_SHADER_GRID = 
"precision mediump float;\n" +
...
export var FRAGMENT_SHADER_GRID = 
"precision mediump float;\n" +
...
//------------------------------------------HITBOX------------------------------------------------------------
export var VERTEX_SHADER_HITBOX = 
"precision mediump float;"+
...
export var FRAGMENT_SHADER_HITBOX =
"precision mediump float;"+
...
//------------------------------------------LINEA RECTA------------------------------------------------------------
export var VERTEX_SHADER_LINEA_RECTA = 
"precision mediump float;"+
...
export var FRAGMENT_SHADER_LINEA_RECTA =
"precision mediump float;"+
...
export function createShader (gl, tipo, codigoGLSL) {
